...
import { getEntrelogin } from "../services/ApiService";
...
function Logine(){
  ...
  const [entrelogin,setEntrelogin]=useState([])
  useEffect(()=>{
    let cpt=true
    getEntrelogin()
    .then(
   ...
   const handleClick = () => {
    let message1=document.querySelector("#form1Example13").value;
    let message2=document.querySelector("#form1Example23").value;
    let message3=document.querySelector("#form1Example17").value;

    let test=0;
    //navigate("/Searchres");
    for(let i in entrelogin){
      if(entrelogin[i].entre_email==message1 && entrelogin[i].entre_password==message2){
        test=1;
      }
    }
    if(test==0){
      ...
      sessionStorage.setItem("logine","yes");
      navigate('/Offrelist', {
        state: {
          enName: message3,
...
return(
    ...
    <section>
        <div class="container-fluid headerdiv p-3 " style={{fontSize: 1.7 + "em"}} >
            ...
            <i className="fas fa-briefcase"></i> Entreprise 
            </h1>
        </div>
    </section>
    ...
    <div class="row d-flex justify-content-center align-items-center ">
      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        <form>
          ...
          <br/>
          <div class="form mb-4">
          <label for="" class="form-label">Nom d'Entreprise</label>
          <input type="text" id="form1Example17" placeholder="Nom d'Entreprise" class="form-control form-control-lg rounded" />
            
          </div>  
          <div class="form mb-4">
          <label for="" class="form-label">Email</label>
          <input type="email" id="form1Example13" placeholder="Login / E-mail" class="form-control form-control-lg rounded" />
            
          </div>

          <div class="form mb-4">
          <label for="" class="form-label">   Mot de passe :</label>
         <input type="password" id="form1Example23" placeholder="Mot de passe " class="form-control form-control-lg rounded" />
          </div> 
          ...
          <div class=" text-lg-start mt-4 pt-2">
            ...
            <p class="small fw-bold mt-2 pt-1 mb-0">Vous n'avez pas de compte ? <a href="/Registere"
